...
- contains an example of a Flux app built in Angular 2, Redux and Immutable.js 
- shows how type-safe immutable classes are possible using Immutable.js in a Typescript enviromment.
